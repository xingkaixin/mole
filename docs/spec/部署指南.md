...
```makefile
.PHONY: deps dev build build-mac build-windows build-linux clean lint format check
...
build-mac:
	...
	wails build -platform darwin/amd64 -o mole-mac-intel
	wails build -platform darwin/arm64 -o mole-mac-arm64
	@echo "Creating universal binary..."
	lipo -create mole-mac-intel mole-mac-arm64 -output mole-universal
